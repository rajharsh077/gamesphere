...
import { Mail, Lock, Gamepad2, LogIn, UserPlus, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="w-full max-w-md rounded-[2.5rem] border border-white/5 bg-[#0e0c15]/80 p-8 shadow-[0_30px_70px_rgba(0,0,0,0.6)] backdrop-blur-2xl sm:p-10">
            ...
            <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-xl border border-white/5 bg-[#13111e]/60 pl-11 pr-4 text-sm text-white placeholder:text-slate-600 outline-none transition focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/10"
                    placeholder="you@gamesphere.gg"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-xl border border-white/5 bg-[#13111e]/60 pl-11 pr-11 text-sm text-white placeholder:text-slate-600 outline-none transition focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/10"
              ...
              <div className="flex items-center justify-between gap-4 pt-1 text-xs">
                <label className="flex items-center gap-2 font-medium text-slate-400 select-none cursor-pointer">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-white/10 bg-[#13111e]/60 accent-violet-600 transition"
                  />
                  Remember Me
                </label>
              ...
              {/* Login Button with Glowing Underlay */}
              <button
                type="submit"
                className="relative flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-slate-100 to-white bg-slate-100 text-slate-950 hover:brightness-105 font-bold shadow-[0_4px_25px_rgba(168,85,247,0.25)] transition duration-300 active:scale-[0.99]"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 items-center">
              <button
                ...
                className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-white/5 bg-[#13111e]/40 px-5 text-xs font-bold text-slate-300 transition hover:bg-white/[0.02] hover:border-white/10 hover:text-white"
              >
            ...
            <div className="mt-8 text-center text-xs font-semibold text-slate-500 lg:hidden">
              New here?{' '}
